...
from LeNet_model import LeNet_CIFAR10
...
def parse_args():
    """PARAMETERS"""
    parser = argparse.ArgumentParser(description="LeNet CIFAR10 Training")
...
def main():
    ...
    writer = SummaryWriter("./LeNet/CIFAR10/runs")
    ...
    torch.save(model.state_dict(), "./LeNet/CIFAR10/LeNet_CIFAR10.pth")
    ...
    plt.savefig("./LeNet/CIFAR10/LeNet_CIFAR10_loss.png")
    plt.show()
    ...
    plt.savefig("./LeNet/CIFAR10/LeNet_CIFAR10_acc.png")
    plt.show()
    ...
    for col in range(3):
        for row in range(3):
            ...
            ax.axis("off")
    plt.savefig("./LeNet/CIFAR10/LeNet_CIFAR10_test.png")
    plt.show()
