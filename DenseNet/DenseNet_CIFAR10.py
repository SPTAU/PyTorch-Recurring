...
def main():
    ...
    writer = SummaryWriter("./DenseNet/CIFAR10/runs")
    ...
    torch.save(model.state_dict(), "./DenseNet/CIFAR10/ResNet_CIFAR10.pth")
    ...
    plt.savefig("./DenseNet/CIFAR10/ResNet_CIFAR10_loss.png")
    plt.show()
    ...
    plt.savefig("./DenseNet/CIFAR10/ResNet_CIFAR10_acc.png")
    plt.show()
    ...
    for col in range(3):
        for row in range(3):
            ...
            ax.axis("off")
    plt.savefig("./DenseNet/CIFAR10/ResNet_CIFAR10_test.png")
    plt.show()
