...
from TestNet_model import TestNet_CIFAR10
...
def parse_args():
    """PARAMETERS"""
    parser = argparse.ArgumentParser(description="TestNet CIFAR10 Training")
...
def main():
    ...
    writer = SummaryWriter("./TestNet/CIFAR10/runs")
    ...
    torch.save(model.state_dict(), "./TestNet/CIFAR10/TestNet_CIFAR10.pth")
    ...
    plt.savefig("./TestNet/CIFAR10/TestNet_CIFAR10_loss.png")
    plt.show()
    ...
    plt.savefig("./TestNet/CIFAR10/TestNet_CIFAR10_acc.png")
    plt.show()
    ...
    for col in range(3):
        for row in range(3):
            ...
            ax.axis("off")
    plt.savefig("./TestNet/CIFAR10/TestNet_CIFAR10_test.png")
    plt.show()
